    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix py-3">
                <h4 class="page-title pull-left">Matriks UN</h4>
                    ...
                    <div class="col-lg-4 col-sm-8">
                        ...
                        <div class="col-12">
                            <b>
                                ...
                                <?php if ($k['jurusan_id'] == $m['jurusan1']): ?>
                                <?=$k['jurusan_nama'];?>
                                <?php endif?>
                                <?php endforeach?>
                            </b>
                            ...
                            <b>
                                <?php foreach ($jurusan as $k): ?>
                                <?php if ($k['jurusan_id'] == $m['jurusan2']): ?>
                                <?=$k['jurusan_nama'];?>
                                <?php endif?>
                                <?php endforeach?>
                            </b>
                            ...
                            <table class="table table-bordered text-center col-12">
                                <thead class="thead-light">
                                    <tr>
                                        <th><?=$s['sub_nama'];?></th>
                                        <?php foreach ($jurusan as $k): ?>
                                        <th><?=$k['jurusan_nama'];?></th>
                                        <?php endforeach?>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach (range(0, count($jurusan) - 1) as $i): ?>
                                    <tr>
                                        <td><b><?=$jurusan[$i]['jurusan_nama'];?></b></td>
...
function update(id, context) {
    ...
    fetch(`/ahp/nilai/un/update/${id}/${context.value}`)
        .then(res => res.json())
        .then(res => {
            console.log(res);
