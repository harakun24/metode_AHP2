    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix py-3">
                <h4 class="page-title pull-left">Matriks Subkriteria</h4>
                    ...
                    <div class="col-lg-8 col-sm-12">
                        <div class="col-12 mt-3">
                            <table class="table table-bordered text-center col-12">
                                ...
                                <tbody>
                                    <?php foreach (range(0, count($sub) - 1) as $i): ?>
                                    <tr>
                                        <td><b><?=$sub[$i]['sub_nama'];?></b></td>
...
function update(id, context) {
    ...
    fetch(`/ahp/nilai/sub/update/${id}/${context.value}`)
        .then(res => res.json())
        .then(res => {
            console.log(res);
